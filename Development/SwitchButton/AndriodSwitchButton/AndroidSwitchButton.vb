...
Public Class AndroidSwitchButton
...
#End Region
        ...
        With PictureBox1
            Select Case _frameState
                Case FrameState.Active
                    ...
                    .Image = My.Resources.AndroidSwitchButton_Frame2
                Case FrameState.Part_Active
                    _frameState = FrameState.Part_Inactive
                    .Image = My.Resources.AndroidSwitchButton_Frame3
                Case FrameState.Part_Inactive
                    _frameState = FrameState.Inactive
                    _activated = False
                    .Image = My.Resources.AndroidSwitchButton_Frame4
        ...
        With PictureBox1
            Select Case _frameState
                ...
                Case FrameState.Part_Active
                    ...
                    _activated = True
                    .Image = My.Resources.AndroidSwitchButton_Frame1
                    Timer1.Enabled = False
            End Select
        End With
    End Sub
    ...
    Private Sub AndroidSwitchButton_Load(sender As Object, e As EventArgs) Handles Me.Load
        If _activated Then
            _frameState = FrameState.Active
            PictureBox1.Image = My.Resources.AndroidSwitchButton_Frame1
        Else
            _frameState = FrameState.Inactive
            PictureBox1.Image = My.Resources.AndroidSwitchButton_Frame4
        End If
    End Sub
