        ...
        Select Case on_off
            Case 0
                Select Case one_to_four
                    Case 4
                        pb_switch.Image = My.Resources.switch_1_ios
                        one_to_four = 4
                        on_off = 1
                        timer_move.Stop()
                    Case 3
                        pb_switch.Image = My.Resources.switch_2_ios
                        one_to_four = 4
                    Case 2
                        pb_switch.Image = My.Resources.switch_3_ios
                        one_to_four = 3
                    Case 1
                        pb_switch.Image = My.Resources.switch_4_ios
                        one_to_four = 2
                End Select
            Case 1
                Select Case one_to_four
